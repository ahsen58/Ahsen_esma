...
class StatisticsGUI:
    ...
    def arayuzu_olustur(self):
        ...
        tk.Label(
            cerceve,
            text="Bölgesel İstatistik Raporu",
        ...
        self.location_selector.pack(pady=10)

        tk.Button(
            cerceve,
            text="İstatistikleri Getir",
            command=self.istatistik_hesapla,
            bg="#ce93d8",
            fg="white",
        ...
        self.lbl_toplam = tk.Label(self.result_frame, text="Toplam Nüfus: -", font=("Helvetica", 13, "bold"), bg="#fce4ec", fg="#880e4f")
        self.lbl_toplam.pack(pady=8)

        self.lbl_kadin = tk.Label(self.result_frame, text="Kadın Oranı: -", font=("Helvetica", 11), bg="#fce4ec", fg="#880e4f")
        self.lbl_kadin.pack(pady=5)

        self.lbl_erkek = tk.Label(self.result_frame, text="Erkek Oranı: -", font=("Helvetica", 11), bg="#fce4ec", fg="#880e4f")
        self.lbl_erkek.pack(pady=5)

        self.lbl_ort_yas = tk.Label(self.result_frame, text="Ortalama Yaş: -", font=("Helvetica", 11), bg="#fce4ec", fg="#880e4f")
        self.lbl_ort_yas.pack(pady=5)

        self.lbl_calisan = tk.Label(self.result_frame, text="Çalışan Oranı: -", font=("Helvetica", 11), bg="#fce4ec", fg="#880e4f")
        self.lbl_calisan.pack(pady=5)

        self.lbl_ogrenci = tk.Label(self.result_frame, text="Öğrenci Oranı: -", font=("Helvetica", 11), bg="#fce4ec", fg="#880e4f")
